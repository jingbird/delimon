...
- **プロフィール設定（初回登録時）** ⭐NEW
  ...
  - 性別
  - 業種
- **将来的に検討**: Google/Apple認証（Phase 2以降）
...
### 2.6 図鑑機能
- **所持キャラクター**: カラー画像で表示
- **未所持キャラクター**: 「？」表示（シルエットなし）
- **相棒キャラクター**: 太枠で強調表示（選択中であることを明示）
- 合計9体（3種類 × 3段階進化）
- **MVP**: 相棒1体のみ所持、他8体は未所持
...
**表示内容**:
- **所持キャラクター**: カラー画像、レベル表示、EXPバー表示
- **相棒キャラクター**: 太枠で強調表示（選択中であることを明示）
- **未所持キャラクター**: 「？」表示（シルエットなし）
- **収集率**: 「1 / 9体」（MVP時点）
- **MVP**: 相棒1体のみ所持、他8体は「？」表示

**キャラクター詳細**（タップ時・Phase 2以降）:
- キャラクター画像
- 名前、レベル
- 現在の経験値
- 進化系統図
